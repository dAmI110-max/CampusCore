      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5">
          ...
          <motion.div
            ...
            className="lg:col-span-8 bg-gradient-to-br from-purple-800 via-purple-900 to-[#240849] dark:from-[#21093f] dark:via-[#18062b] dark:to-[#0f041e] rounded-[28px] sm:rounded-[32px] p-6 sm:p-10 relative overflow-hidden flex flex-col justify-between border border-purple-400/40 dark:border-purple-800/60 shadow-xl shadow-purple-950/20 text-white min-h-[360px]"
          >
            {/* Ambient Blurred Orbs */}
            <div className="absolute -right-16 -bottom-16 w-72 h-72 bg-purple-400/25 dark:bg-purple-600/15 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute -right-8 -top-8 w-44 h-44 bg-purple-300/25 dark:bg-purple-400/15 rounded-full blur-2xl pointer-events-none" />

            <div className="relative z-10 space-y-4 max-w-xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-700/50 border border-purple-300/30 text-purple-100 text-xs font-bold backdrop-blur-xs tracking-wider uppercase">
              ...
              <p className="text-purple-100 text-sm sm:text-base leading-relaxed max-w-md">
              ...
              <form onSubmit={handleSearchSubmit} className="pt-2 relative flex items-center max-w-lg">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-24 py-2.5 sm:py-3 bg-white dark:bg-slate-900 text-slate-900 dark:text-white placeholder:text-slate-400 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-medium focus:outline-hidden focus:ring-2 focus:ring-purple-400 shadow-md border border-transparent dark:border-slate-700"
                />
                <button
                  type="submit"
                  className="absolute right-1.5 px-3.5 py-1.5 sm:py-2 bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs rounded-lg sm:rounded-xl transition-all shadow-xs"
                >
                  Search
                </button>
              </form>
            ...
            <div className="relative z-10 pt-6 flex flex-wrap items-center gap-3">
              <button
                ...
                className="bg-white text-purple-900 hover:bg-purple-50 px-6 sm:px-8 py-2.5 sm:py-3 rounded-2xl font-bold text-xs sm:text-sm shadow-md hover:shadow-lg transition-all flex items-center gap-2 active:scale-95 cursor-pointer"
              >
                Explore Market <ArrowRight className="w-4 h-4" />
              </button>
              <button
                onClick={onOpenCreateProduct}
                className="bg-purple-700/60 hover:bg-purple-700/80 text-white border border-purple-300/30 px-6 sm:px-8 py-2.5 sm:py-3 rounded-2xl font-bold text-xs sm:text-sm backdrop-blur-xs transition-all flex items-center gap-2 active:scale-95 cursor-pointer"
              >
                + Sell Something
              </button>
            </div>
          ...
          <motion.div
            ...
            className="lg:col-span-4 bg-white dark:bg-slate-900/90 border border-purple-100/80 dark:border-purple-950/60 rounded-[28px] sm:rounded-[32px] p-6 shadow-xs flex flex-col justify-between"
          >
            <div>
              ...
              {/* Student info box */}
              <div className="mt-4 flex items-center gap-3.5 p-3 rounded-2xl bg-purple-50/40 dark:bg-slate-800/80 border border-purple-100/60 dark:border-slate-700">
                <img
                  src={
                  ...
                  className="w-13 h-13 rounded-2xl object-cover ring-2 ring-purple-500/25"
                />
            ...
            <div className="mt-4 pt-4 border-t border-purple-100/60 dark:border-slate-800 grid grid-cols-3 gap-2">
              <div className="text-center p-2 rounded-xl bg-purple-50/40 dark:bg-slate-800/60">
                <p className="text-lg font-extrabold text-purple-600 dark:text-purple-400">{userAds}</p>
                <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Ads</p>
              </div>
              <div className="text-center p-2 rounded-xl bg-purple-50/40 dark:bg-slate-800/60">
                <p className="text-lg font-extrabold text-purple-600 dark:text-purple-400">{userSold}</p>
                <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Sold</p>
              </div>
              <div className="text-center p-2 rounded-xl bg-purple-50/40 dark:bg-slate-800/60">
                <p className="text-lg font-extrabold text-purple-600 dark:text-purple-400">{userLikes}</p>
          ...
          {hotProduct ? (
              ...
              <div className="p-4 sm:p-5 flex flex-col justify-between flex-1">
                <div>
                  <div className="flex justify-between items-start mb-1.5">
                    <h4 className="font-bold text-slate-900 dark:text-white text-sm leading-tight line-clamp-1 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                      {hotProduct.title}
                    </h4>
                    <p className="text-purple-700 dark:text-purple-300 font-black text-sm shrink-0 ml-2">
            ...
            <motion.div
              ...
              transition={{ duration: 0.3, delay: 0.2 }}
              onClick={onOpenCreateProduct}
              className="lg:col-span-4 bg-white dark:bg-slate-900/90 border border-purple-100/80 dark:border-purple-950/60 rounded-[28px] sm:rounded-[32px] p-6 shadow-xs flex flex-col justify-between group cursor-pointer hover:shadow-md hover:border-purple-300 dark:hover:border-purple-700 transition-all text-center"
            >
              <div className="flex flex-col items-center justify-center flex-1 py-4">
                <div className="w-14 h-14 rounded-2xl bg-purple-50 dark:bg-purple-950/60 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-3 border border-purple-100 dark:border-purple-900/50 group-hover:scale-105 transition-transform">
                ...
                <span className="inline-flex items-center gap-1.5 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs rounded-xl shadow-xs transition-colors">
                  <PlusCircle className="w-4 h-4" />
                  Be the first seller to list yours.
                </span>
              </div>
              <div className="pt-3 border-t border-purple-50 dark:border-slate-800 text-[11px] text-slate-400">
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-white dark:bg-slate-900/90 border border-purple-100/80 dark:border-purple-950/60 rounded-[28px] sm:rounded-[32px] p-5 sm:p-6 shadow-xs flex flex-col justify-between gap-4"
          >
            <div className="flex justify-between items-center">
              <h3 className="text-base sm:text-lg font-bold text-slate-800 dark:text-white flex items-center gap-2">
                <Home className="w-4 h-4 text-purple-600 dark:text-purple-400" /> Hostel Listings
              </h3>
              <button
                onClick={onExploreAccommodation}
                className="text-xs font-bold text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 flex items-center gap-1 cursor-pointer"
              >
              ...
              {sampleHostels.length > 0 ? (
                sampleHostels.map((acc) => (
                  <div
                    ...
                    className="p-3.5 bg-slate-50 dark:bg-slate-800/70 rounded-2xl border border-slate-100 dark:border-slate-700 flex items-center gap-3.5 hover:bg-purple-50/50 dark:hover:bg-slate-800 hover:border-purple-200 dark:hover:border-purple-800 transition-all cursor-pointer group"
                  >
                    <img
                      src={acc.images[0]}
                      alt={acc.title}
                    ...
                    <div className="truncate flex-1">
                      <p className="font-bold text-slate-800 dark:text-slate-200 text-xs sm:text-sm truncate group-hover:text-purple-600 dark:group-hover:text-purple-400">
                        {acc.title}
                      </p>
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 truncate flex items-center gap-1 mt-0.5">
                        <MapPin className="w-2.5 h-2.5 text-purple-500" /> {acc.distanceToCampus}
                      </p>
                      <p className="text-purple-700 dark:text-purple-300 font-bold text-xs mt-0.5">
                ...
                <div className="py-6 px-4 text-center rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-dashed border-slate-200 dark:border-slate-700/60">
                  <Home className="w-8 h-8 text-purple-500/60 mx-auto mb-2" />
            ...
            {/* Roommate tip */}
            <div className="p-3 bg-purple-50 dark:bg-purple-950/60 rounded-xl border border-purple-100 dark:border-purple-900/50 flex items-center gap-2.5 text-xs text-purple-950 dark:text-purple-200 font-medium">
          ...
          <motion.div
            ...
            className="lg:col-span-3 bg-[#130b22] dark:bg-[#11081e] border border-purple-950/60 rounded-[28px] sm:rounded-[32px] p-5 sm:p-6 text-white shadow-xl flex flex-col justify-between"
          >
            <div>
              ...
              <p className="text-purple-200/60 text-xs font-medium mb-4">Live updates from 6 campuses</p>
              ...
              <div className="space-y-3.5">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-purple-200/70">Buyer & seller protection active</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-purple-200/70">All 6 UNIOSUN campuses ready</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-purple-200/70">Open for new student listings</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <button
              onClick={onExploreMarketplace}
              className="mt-6 w-full py-2.5 bg-purple-600/30 hover:bg-purple-600/50 border border-purple-400/30 rounded-xl text-xs font-bold transition-all text-center cursor-pointer text-white"
            >
              Browse All Listings
            </button>
          </motion.div>
