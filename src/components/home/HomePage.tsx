...
import { PurpleFlowerLiveBackground } from './PurpleFlowerLiveBackground';
import {
  Sparkles,
  ArrowRight,
  Home,
...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className="relative min-h-screen text-slate-900 dark:text-slate-100 transition-colors">
      {/* Live Purple Flower Wallpaper (Homepage Alone) */}
      <PurpleFlowerLiveBackground />
      ...
      <div className="relative z-10 space-y-0">
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
              <div
                ...
                className="p-4 rounded-3xl bg-white/85 dark:bg-slate-900/85 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 hover:border-purple-500 dark:hover:border-purple-400 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
              >
                ...
                <div className="mt-3">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Graphics, tutoring, hair & tech</p>
                </div>
              </div>

              <div
                onClick={() => onNavigateToView('jobs')}
                className="p-4 rounded-3xl bg-white/85 dark:bg-slate-900/85 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 hover:border-teal-500 dark:hover:border-teal-400 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
              >
                ...
                <div className="mt-3">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Gigs, part-time & internships</p>
                </div>
              </div>

              <div
                onClick={() => onNavigateToView('events')}
                className="p-4 rounded-3xl bg-white/85 dark:bg-slate-900/85 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 hover:border-pink-500 dark:hover:border-pink-400 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
              >
                ...
                <div className="mt-3">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Dinners, tech fests & sports</p>
                </div>
              </div>

              <div
                onClick={() => onNavigateToView('communities')}
                className="p-4 rounded-3xl bg-white/85 dark:bg-slate-900/85 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 hover:border-indigo-500 dark:hover:border-indigo-400 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
              >
                ...
                <div className="mt-3">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Departmental clubs & groups</p>
                </div>
              </div>

              <div
                onClick={() => onNavigateToView('businesses')}
                className="p-4 rounded-3xl bg-white/85 dark:bg-slate-900/85 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 hover:border-amber-500 dark:hover:border-amber-400 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between col-span-2 sm:col-span-1"
              >
                ...
                <div className="mt-3">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Verified local student vendors</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <section className="py-10 bg-white/75 dark:bg-slate-900/75 backdrop-blur-md border-y border-slate-200/80 dark:border-slate-800/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {latestProducts.length > 0 ? (
              ...
              <div className="text-center py-12 px-4 rounded-3xl bg-slate-50/80 dark:bg-slate-800/60 backdrop-blur-sm border border-dashed border-slate-200 dark:border-slate-800">
